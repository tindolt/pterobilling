...
Route::get('/test', 'Api\Client\SoftwareController@update')->name('update');
Route::prefix('/{id}')->group(function () {
    ...
    Route::prefix('/subdomain')->name('subdomain.')->group(function () {
        Route::put('/', 'Api\Client\SubdomainController@update')->name('update');
    });
    
    Route::prefix('/software')->name('software.')->group(function () {
        Route::put('/', 'Api\Client\SoftwareController@update')->name('update');
    });
});
