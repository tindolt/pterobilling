...
class UpdateConfig extends Command
{
    ...
    public function handle()
    {
        ...
        $this->editEnv('DB_DATABASE', $this->ask('Database Name', config('database.connections.mysql.username')));
        $this->editEnv('DB_USERNAME', $this->ask('Database Username', config('database.connections.mysql.password')));
        ...
        $this->editEnv('MAIL_ENCRYPTION', $this->choice('SMTP Encryption', ['tls', 'ssl'], config('mail.mailers.smtp.encryption')));
