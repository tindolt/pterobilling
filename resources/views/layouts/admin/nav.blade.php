        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="storeMenu" class="dropdown-menu border-0 shadow">
                ...
                <li class="dropdown-submenu dropdown-hover">
                    <a id="plansMenu" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false" class="dropdown-item dropdown-toggle">Plans</a>
